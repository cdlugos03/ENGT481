...
def angleRead(cor, cor2, cor3):
    ...
    while len(line1) < 6: #read until line is filled
        line1.extend(esp32.read(6 - len(line1))) #reads response from ESP32
