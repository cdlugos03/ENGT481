...
# #-----CONTROL CODE-------#
# cereal = serial.Serial('/dev/ttyACM0', 115200, timeout=0.0003) #initiates connection, will restart arduino code
...
# 
# cereal.write(0x0F) #send start command to Arduino
# 
# try:
#     while True:
...
#         while cereal.in_waiting <= 0: #infinitely waits until arduino sends serial value
...
#         positionRaw = (line>>16) & 0xFFFF
#         angleRaw = line & 0xFFFF
#         
...
#         xDiv = xDivLast + aCart * Ts #calulate target art speed
...
#     cereal.write(0xF0) #send stop command to Arduino
