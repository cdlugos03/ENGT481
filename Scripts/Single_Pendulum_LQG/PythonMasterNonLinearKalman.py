...
#lambdify for evaluation with RK4 integration
ModelSubs = NonLinMod.subs(vals)
Ydot = sp.lambdify((t, Y, F), ModelSubs, 'numpy')
...
#             print(angleRaw)
        ...
        aCart = u / mcartVal #calculate target cart acceleration
